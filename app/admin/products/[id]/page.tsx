...
export default function DetailProductPage({ params }: any) {
    ...
    if (isLoading) {
        return (
            <div className="space-y-6">
                <h1 className="font-serif text-3xl font-bold">Chi tiết Sản Phẩm</h1>
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="font-serif text-3xl font-bold mb-2">Chi tiết Sản Phẩm</h1>
